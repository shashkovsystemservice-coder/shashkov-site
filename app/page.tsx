...
const process = [
  ...
  ["04", "Фиксируем результат и следующий шаг", "Что именно должно измениться, какие объяснения пока остаются гипотезами и что имеет смысл проверить или менять первым."],
] as const;
    ...
    <main id="top">
      <div className="page-shell">
        ...
        <section className="hero">
          <div className="hero-copy">
            ...
            <p className="hero-lead">Помогаю собственникам разобраться, что действительно мешает бизнесу двигаться дальше — когда не растут продажи, непонятно, чем вы отличаетесь, почему клиенты выбирают других или что именно менять в маркетинге. Реклама, сайт, позиционирование или новый подрядчик могут оказаться решением — но не обязательно причиной.</p>
      ...
      <section className="process-stage" id="process">
        <div className="page-shell">
          ...
          <div className="process-outcome">
            ...
            <p className="outcome-statement">Не список инструментов, а ясность: что именно должно измениться, что может этому мешать и что проверять первым</p>
        ...
        <div className="page-shell">
          ...
          <article className="case-editorial">
            ...
            <div className="case-main">
              ...
              <p className="research-thesis">В работе использовались данные отгрузок, реконструкция выигранных и проигранных сделок, конкурентный анализ, роли участников покупки и разделение фактов, гипотез и неизвестного. Часть выводов сознательно осталась гипотезами до проверки рынком и экономикой.</p>
        ...
        <div className="page-shell">
          ...
          <article className="research-feature research-fitness">
            ...
            <div className="research-copy">
              ...
              <p className="research-thesis">Пример того, что та же диагностическая логика работает и в B2C: сначала раскладывается бизнес-система, а уже потом выбирается область для диагностики конкретной компании.</p>
      ...
      <section className="about-stage">
        <div className="page-shell about-grid">
          <div>
            <p className="eyebrow">Как устроена аналитическая работа</p>
            <h2>ИИ у меня не источник истины, а инструмент работы с собственной базой знаний</h2>
          </div>
          <div className="about-copy">
            ...
            <p>Для работы я собираю собственную базу знаний из академических исследований, фундаментальной и практической профессиональной литературы, отраслевых данных и материалов конкретного проекта.</p>
            ...
            <p>Сам по себе правдоподобный ответ модели ещё не решение: его нужно уметь оценить, сопоставить с фактами и докрутить. Качество источников, постановка вопроса, интерпретация противоречий и ответственность за вывод остаются человеческой работой.</p>
      ...
      <section className="executor-stage">
        <div className="page-shell executor-grid">
          ...
          <div>
            ...
            <p>Собственнику не нужно самому настраивать рекламу, писать тексты или управлять каждым инструментом. Но важно понимать, какую проблему решает маркетинг, какой результат нужен бизнесу и по каким признакам оценивать решение — чтобы правильно поставить задачу, выбрать людей и не менять инструменты вслепую.</p>
          </div>
        </div>
      </section>
      ...
      <section className="depth-stage" id="depth">
        <div className="page-shell depth-layout">
          ...
          <div className="depth-list">
            ...
            <details>
              <summary>Сначала образ результата, потом инструменты</summary>
              <p>До сайта, рекламы, контента или новой команды важно договориться, что именно должно измениться в бизнесе и по каким признакам будет понятно, что решение сработало.</p>
            </details>
            <details>
      ...
      <section className="about-stage" id="about">
        <div className="page-shell about-grid">
          ...
          <div className="about-copy">
            ...
            <p>Поэтому я рассматриваю маркетинг вместе с продуктом, продажами, сервисом, операционной моделью и экономикой бизнеса — а не как отдельный набор рекламных инструментов. Этот способ анализа применим и к B2B, и к компаниям, которые работают с конечным потребителем.</p>
            <div className="trajectory">
      ...
      <section className="executor-stage">
        <div className="page-shell executor-grid">
          ...
          <div>
            ...
            <p>Если причина уже понятна и нужен дизайнер, SEO-специалист, рекламное агентство, продавец или внутренняя команда, диагностика ради диагностики не нужна. Моя задача — помочь понять, что действительно требуется, сформулировать ожидаемый результат и критерии, по которым можно оценить работу.</p>
          </div>
        </div>
      </section>
