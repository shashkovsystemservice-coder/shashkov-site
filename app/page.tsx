      ...
      <section className="situations-stage" id="situations">
        <div className="page-shell">
          ...
          <article className="lead-situation">
            ...
            <p className="lead-answer">Да. Я могу помочь разобраться в ситуации, определить приоритеты и оставить вашей команде логику действий, критерии выбора и инструменты, с которыми она сможет двигаться дальше самостоятельно — без необходимости превращать собственника в маркетолога.</p>
          </article>
      ...
      <section className="executor-stage">
        <div className="page-shell executor-grid">
          ...
          <div>
            ...
            <p>Собственнику не нужно самому настраивать рекламу, писать тексты или управлять каждым инструментом. Но полезно понимать, какую проблему решает маркетинг, какой результат нужен бизнесу, кому и почему клиент должен выбрать именно вас — чтобы правильно поставить задачу, выбрать людей и оценить качество решения.</p>
          </div>
        </div>
      </section>
