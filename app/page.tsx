...
const situations = [
  ...
  "Маркетолог, отдел или подрядчики работают — но общей картины всё равно не складывается",
...
const currentProjects = [
  {
    ...
    reframing: "Продажи → модель продукта, ответственность, роли в выборе и доказательства.",
  ...
  },
  {
    ...
    reframing: "Редизайн → категория, причины выбора, продукт и поисковые сценарии.",
...
const decisionLogic = [
  {
    n: "01",
    title: "Отделить вопрос от готовой версии ответа",
    text: "Не принимаю «нужна реклама», «нужен сайт» или «нужно снизить цену» за диагноз. Сначала отделяю факты от предположений.",
  },
  {
    n: "02",
    title: "Собрать связанные части в одну картину",
    text: "Смотрю, как между собой связаны рынок, клиент, продукт, ценность, доказательства, продажи, каналы и способность компании выполнить обещание.",
  },
  {
    n: "03",
    title: "Найти решение, которое стоит проверять первым",
    text: "Сравниваю конкурирующие объяснения и выбираю проверку, которая даст больше ясности до больших затрат.",
  },
] as const;
...
export default function Home() {
  return <main id="top">
    <div className="page-shell">
      ...
      <section className="hero">
        <div className="hero-copy">
          <p className="eyebrow">Когда в маркетинге много действий, а ясности нет</p>
          <h1>Не уверены, что именно сейчас стоит менять?</h1>
          <p className="hero-lead">Помогаю разобраться, где находится реальное ограничение и что делать первым.</p>
          <p className="hero-money-line">До вложений в очередную рекламу, сайт, канал или другое решение.</p>
    ...
    <section id="situations" className="situations-stage">
      <div className="page-shell">
        <div className="section-intro situations-intro">
          ...
          <h2>Локальный запрос ещё не говорит, где находится реальная проблема.</h2>
        </div>
        ...
        <div className="reframe-block">
          ...
          <p>И «клиенты сравнивают по цене» ещё не значит, что проблема только в цене. Причина может находиться в продукте, ценности, доверии, доказательствах, продажах, канале — или в связи между ними.</p>
    ...
    <section id="method" className="decision-method-stage">
      <div className="page-shell">
        <div className="section-intro decision-method-intro">
          ...
          <h2>Не исследую всё подряд. Собираю картину вокруг решения, которое нужно принять.</h2>
        </div>
        ...
        <p className="decision-method-note"><strong>Результат — не список замечаний, а понимание: что сейчас определяет результат, что проверять первым и что пока делать не нужно.</strong></p>
    ...
    <section id="brief" className="brief-stage">
      <div className="page-shell">
        <div className="section-intro brief-intro">
          ...
          <h2>Не просто читать — пройти первые шаги на своём вопросе.</h2>
        </div>
        <div className="brief-card">
          <p className="eyebrow">Decision Brief · 6 вопросов · без звонка</p>
          <h3>Сформулируйте ситуацию так, как видите её сейчас. Диагноз знать заранее не нужно.</h3>
    ...
    <section id="case" className="case-stage">
      <div className="page-shell case-shell">
        ...
        <div className="case-steps">
          ...
          <div><span>Что выяснили</span><p>Продукт и цена не объясняли ситуацию целиком. Важнее оказались доверие, видимость и то, как компания попадала в выбор клиента до личной продажи.</p></div>
    ...
    <section className="continuation-stage" aria-labelledby="continuation-title">
      <div className="page-shell">
        <div className="section-intro continuation-intro">
          ...
          <h2 id="continuation-title">Глубина работы зависит от вопроса.</h2>
        ...
        <div className="work-grid work-grid-returned" aria-label="Как может продолжиться работа">
          <article><p className="eyebrow">1 · Самостоятельно</p><h3>Decision Brief</h3><p>Сформулировать ситуацию и увидеть, что стоит проверить первым.</p><a className="service-route service-route-primary" href="/diagnostic">Пройти 6 вопросов →</a></article>
          <article><p className="eyebrow">2 · Основной формат</p><h3>Маркетинговый разбор бизнеса</h3><p>Независимо разобрать ситуацию, собрать причинную картину и определить приоритет решения.</p><a className="service-route" href="#contact">Обсудить разбор →</a></article>
          <article><p className="eyebrow">3 · Если нужна глубина</p><h3>Стратегический проект</h3><p>Углубиться в рынок, клиента, продукт, ценность, продажи и исполнение — только там, где это действительно нужно.</p><a className="service-route" href="/work">Посмотреть, как проходит работа →</a></article>
        </div>
      </div>
    </section>
    ...
    <section className="projects-stage projects-stage-compact projects-stage-memory-pass">
      <div className="page-shell">
        <div className="section-intro"><p className="eyebrow">07 · Ещё примеры</p><h2>Один и тот же принцип — в разных бизнес-ситуациях.</h2></div>
    ...
    <section className="about-stage" aria-labelledby="knowledge-title">
      <div className="page-shell about-grid">
        <div><p className="eyebrow">08 · Почему могу смотреть шире одного инструмента</p><h2 id="knowledge-title">За разбором стоит связанная система маркетинговых знаний.</h2></div>
        <div className="about-copy">
          <p className="about-inside-business"><strong>Не одна любимая модель и не ответ AI на отдельный вопрос.</strong></p>
          <p>Я связываю классические маркетинговые школы, собственные реконструкции методологий, исследования и данные. Под конкретную задачу выбираю только те области и методы, которые помогают принять решение.</p>
          <div className="about-foundations">
            <div><strong>Методологии за интерфейсом</strong><span>Рынок · клиент · продукт · ценность · позиционирование · цена · продажи · каналы · доказательства.</span></div>
            <div><strong>Инструменты под задачу</strong><span>Исследования, AI, парсеры, боты и собственные рабочие инструменты — когда они реально сокращают путь к проверке.</span></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="faq-stage">
      <div className="page-shell">
        <div className="section-intro"><p className="eyebrow">09 · Перед первым шагом</p><h2>Шесть коротких ответов.</h2></div>
        <div className="faq-list">
          ...
          <details><summary>У нас уже есть маркетолог или отдел маркетинга. Тогда зачем внешний разбор?</summary><p>Наличие команды не отменяет ситуаций, где вопрос проходит через несколько функций или нужен независимый взгляд без привязки к внутренней версии решения. Разбор не заменяет команду — он помогает проверить саму постановку задачи и приоритет.</p></details>
    ...
    <section id="contact" className="contact-stage">
      <div className="page-shell contact-grid">
        <div>
          <p className="eyebrow eyebrow-light">10 · Следующий шаг</p>
          <h2>Можно начать с самой ситуации — без обязательного звонка.</h2>
          <p>Если вопрос пока неясный — можно пройти 6 вопросов. Если уже конкретный — просто написать, что происходит и какое решение нужно принять.</p>
