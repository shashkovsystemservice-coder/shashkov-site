      ...
      <div className="page-shell">
        ...
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow">Для собственников B2B-компаний · сложные продукты</p>
            <h1>Первичный запрос — ещё не диагноз</h1>
            <p className="hero-lead">Помогаю собственникам разобраться, что действительно мешает бизнесу двигаться дальше — когда не растут продажи, непонятно, чем вы отличаетесь или что именно менять в маркетинге. Реклама, сайт, позиционирование или новый подрядчик могут оказаться решением — но не обязательно причиной.</p>
      ...
      <section className="situations-stage" id="situations">
        <div className="page-shell">
          <div className="section-intro situations-intro">
            ...
            <p>Не нужно переводить её на язык маркетинга. Достаточно описать, что происходит в бизнесе.</p>
          </div>
