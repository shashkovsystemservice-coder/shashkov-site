    ...
    <section id="situations" className="situations-stage">
      <div className="page-shell">
        ...
        <div className="reframe-block">
          ...
          <p>И «клиенты сравниют по цене» ещё не значит, что проблема только в цене: сначала нужно понять, с чем вас сравнивают, какую ценность видят и каких доказательств не хватает.</p>
