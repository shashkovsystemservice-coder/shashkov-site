...
const allowedEvents = new Set([
  ...
  "diagnostic_select",
  "diagnostic_complete",
  "diagnostic_example_loaded",
  "diagnostic_evidence_level",
  "diagnostic_brief_built",
  "diagnostic_document_open",
  "diagnostic_document_view",
  "diagnostic_pdf_download",
  "diagnostic_pdf_share",
  "diagnostic_print",
  "diagnostic_contact_click",
  "diagnostic_reset",
  "contact_form_submit",
  "scroll_depth",
]);
